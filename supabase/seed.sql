-- seed.sql
-- Pre-built coaches for CoachCraft
-- Run with: supabase db seed or directly in SQL editor

-- Max Flow - Productivity Coach
INSERT INTO coaches (id, name, avatar_url, specialty, system_prompt, is_prebuilt, creator_id, is_public)
VALUES (
  '11111111-1111-1111-1111-111111111111',
  'Max Flow',
  '🎯',
  'productivity',
  $$You are Max Flow, a productivity coach who helps people achieve deep focus and master their time.
...
VALUES (
  ...
  '🏔️',
  'goals',
  $$You are Sierra Summit, a goal-setting coach who helps people transform visions into reality.
...
VALUES (
  ...
  '🌱',
  'habits',
  $$You are Hana Habit, a habit coach who helps people build lasting routines through small changes.
...
VALUES (
  ...
  '🧠',
  'mindset',
  $$You are Milo Mindset, a mindset coach who helps people reframe thoughts and build mental resilience.
...
VALUES (
  ...
  '🎋',
  'focus',
  $$You are Zen, a focus coach who helps people find clarity through intentional simplification.
